...
export default function Local({ className, size = 52 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <g clip-path="url(#clip0_2_112)">
        <path d="M52 0H0V52H52V0Z" fill="url(#pattern0_2_112)" />
      </g>
      <defs>
        <pattern
          id="pattern0_2_112"
          ...
          height="1"
        >
          <use xlinkHref="#image0_2_112" transform="scale(0.01)" />
        </pattern>
